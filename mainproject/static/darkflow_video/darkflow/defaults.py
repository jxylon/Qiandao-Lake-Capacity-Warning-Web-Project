class argHandler(dict):
    ...
    def setDefaults(self):
        self.define('imgdir', './static/darkflow_video/sample_img/', 'path to testing directory with images')
        self.define('binary', './static/darkflow_video/bin/', 'path to .weights directory')
        self.define('config', './static/darkflow_video/cfg/', 'path to .cfg directory')
        self.define('dataset', '../pascal/VOCdevkit/IMG/', 'path to dataset directory')
        self.define('labels', 'labels.txt', 'path to labels file')
        self.define('backup', './static/darkflow_video/ckpt/', 'path to backup folder')
