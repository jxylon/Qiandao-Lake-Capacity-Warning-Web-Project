...
class Deviceinfo(models.Model):
    ...
    adminername = models.CharField(max_length=255, blank=True, null=True)
...
class Mobile(models.Model):
    ...
    forestbar = models.CharField(db_column='forestBar', max_length=255, blank=True, null=True)  # Field name made lowercase.
    lioncity = models.CharField(db_column='lionCity', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class WifiNumsDay(models.Model):
    id = models.IntegerField(primary_key=True)
...
class WifiNumsMonth(models.Model):
    id = models.IntegerField(primary_key=True)
